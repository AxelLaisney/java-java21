...
public class Stream_04_Test {
    ...
    public void test_builder() throws Exception {
        ...
        Stream<Object> result = Stream.<Object>builder().add("Alexandra").add("Cyril").add("Johnny").add("Marion").add("Sophie").build();
    ...
    public void test_iterate() throws Exception {
        ...
        Stream<Integer> result2 = Stream.iterate(1, i -> i < 6, i -> ++i);
